...
// import Profile3 from "../assets/img/team/taeni.jpg";
...
//                     <span className="mb-0 font-small fw-bold">Divya Shah</span>
//                   </div>
//                 </div>
//               </Dropdown.Toggle>
...
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faCog, faEnvelopeOpen, faPlus, faSearch, faSignOutAlt, faUserShield } from "@fortawesome/free-solid-svg-icons";
import { faUserCircle } from "@fortawesome/free-regular-svg-icons";
import { Row, Col, Nav, Form, Image, Navbar, Dropdown, Container, ListGroup, InputGroup } from '@themesberg/react-bootstrap';
        ...
        <div className="d-flex justify-content-between w-100">
          ...
          <Nav className="align-items-center">
            ...
            <Dropdown as={Nav.Item}>
              ...
              <Dropdown.Menu className="user-dropdown dropdown-menu-right mt-2">
                <Dropdown.Item className="fw-bold"> {/* Add onClick event for logout */}
                  <FontAwesomeIcon icon={faUserCircle} className="me-2" /> My Profile
                </Dropdown.Item>
                <Dropdown.Item className="fw-bold">
                  <FontAwesomeIcon icon={faCog} className="me-2" /> Settings
